...
from .views import BautismoBrowse, MatrimonioBrowse, EntierroBrowse, PersonaBrowse
from .views import BautismoDetailView, MatrimonioDetailView, EntierroDetailView, PersonaDetailView, LugarDetailView
